...
export class AdminpageProjecttaskcategoryComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.apiService
      .getAllSimple<ProjectTaskCategory>('ProjectTaskCategory')
      .subscribe((data) => {
  ...
  addButton() {
    if (this.registerForm.valid) {
      ...
      this.apiService
        .post<ProjectTaskCategory, ProjectTaskCategory>(
          'ProjectTaskCategory',
          this.newEntity
        )
        .subscribe((data) => {
  ...
  saveButton(entity: ProjectTaskCategory) {
    if (this.editForm.valid) {
      ...
      this.apiService
        .update<boolean, ProjectTaskCategory>(
          'ProjectTaskCategory',
          this.newEntity
        )
  ...
  deleteButton(entity: ProjectTaskCategory) {
    this.apiService
      .delete<ProjectTaskCategory, number>('ProjectTaskCategory', entity.id!)
      .subscribe(() => {
